...
describe('validate/validators', () => {
  describe('validators#passed', () => {
    it('should return true when callback passed', () => {
      expect(validators.passed(200, value => value > 100)).toBeTruthy();
    });
    it('should return false when callback failed', () => {
      expect(validators.passed(50, value => value > 100)).toBeFalsy();
    });
  });
  ...
  describe('validators#isBase32', () => {
    it('should return true when passed', () => {
      expect(validators.isBase32('ZG======')).toBeTruthy();
    });
    it('should return false when failed', () => {
      expect(validators.isBase32('12345')).toBeFalsy();
    });
  });
  ...
  describe('validators#isByteLength', () => {
    it('should return true when passed', () => {
      expect(validators.isByteLength('abc', 3)).toBeTruthy();
    });
    it('should return false when failed', () => {
      expect(validators.isByteLength('abc', 4)).toBeFalsy();
    });
  });
